...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  1 00:53:18 2020

Markov 1 - Random Walk

Read probabilities from probabilities-markov-1-random-walk.txt
Use markov-1-text-file-random-walk.py to generate probabilities
"""
...
def main():
    filename = 'probabilities-markov-1-random-walk.txt'
